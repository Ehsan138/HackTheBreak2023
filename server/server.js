...
app.post('/', async (req, res) => {
    try {
        ...
        if (count < 1) {
            ...
            // gptPrompt = `You are a job interviewer in an interview. You just asked the following question ${question}. The interviewee responded with ${prompt}.
            //  Create a bullet form list of ways their response could be improved upon using STAR format. Then can you give me another interview question.`
